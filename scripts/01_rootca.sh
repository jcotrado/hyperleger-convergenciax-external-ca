...
########################
#CONVERGENCIAX - Registra la CA intermedia en cada PKI de entidad
#
# 1) enrola el usuario admin en root CA
# 2) registra el  usuario/password de "int.ca.convergenciax.com" en la rootCA (Se utilizara al emitir el certificado intermedio)
# 3) enrola el usuario admin en root TLS
# 4) registra el  usuario/password de "tls.int.ca.convergenciax.com"  en la rootTLS (Se utilizara al emitir el certificado intermedio)
########################
